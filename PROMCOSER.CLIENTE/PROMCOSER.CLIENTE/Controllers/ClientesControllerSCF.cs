...
namespace PROMCOSER.CLIENTE.Controllers
{
    ...
    [ApiController]
    public class ClientesControllerSCF : ControllerBase
    {
        private readonly PromcoserContext _context;

        public ClientesControllerSCF(PromcoserContext context)
        {
            _context = context;
        }

        // GET: api/ClientesControllerSCF
        [HttpGet]
        ...
        // GET: api/ClientesControllerSCF/5
        [HttpGet("{id}")]
        ...
        // PUT: api/ClientesControllerSCF/5
        ...
        // POST: api/ClientesControllerSCF
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/ClientesControllerSCF/5
        [HttpDelete("{id}")]
