...
namespace PROMCOSER.CLIENTE.DOMAIN.Infraestructure.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=PROMCOSER;User=sa;Pwd=123456789;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__cliente__677F38F5D2407AA5");
        ...
        {
            entity.HasKey(e => e.IdDetalleParteDiario).HasName("PK__detalle___F8BD27F88934F927");
        ...
        {
            entity.HasKey(e => e.IdMaquinaria).HasName("PK__maquinar__8B61DA97E558AF6B");
        ...
        {
            entity.HasKey(e => e.IdParteDiario).HasName("PK__parte_di__D1A7335487118E07");
        ...
        {
            entity.HasKey(e => e.IdPersonal).HasName("PK__personal__418FB8087ECB0259");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__rol__6ABCB5E0E358F784");
        ...
        {
            entity.HasKey(e => e.IdUbigeo).HasName("PK__ubigeo__F21B090C35102F32");
