...
namespace PROMCOSER_API.Controllers
{
    ...
    public class DetalleParteDiariosController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<DetalleParteDiario>> GetDetalleParteDiario(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDetalleParteDiario(long id, DetalleParteDiario detalleParteDiario)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteDetalleParteDiario(long id)
        {
            var detalleParteDiario = await _context.DetalleParteDiario.FindAsync(id);
            if (detalleParteDiario == null)
            {
        ...
        private bool DetalleParteDiarioExists(long id)
        {
