...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=HernanDesktop\\MSSQLSERVER01;Database=PROMCOSER;Integrated Security=true;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__cliente__677F38F5EBCFD743");
        ...
        {
            entity.HasKey(e => e.IdDetalleParteDiario).HasName("PK__detalle___F8BD27F8E3A1F1D4");
        ...
        {
            entity.HasKey(e => e.IdMaquinaria).HasName("PK__maquinar__8B61DA97D616F1FA");
        ...
        {
            entity.HasKey(e => e.IdParteDiario).HasName("PK__parte_di__D1A73354F87127A3");
        ...
        {
            entity.HasKey(e => e.IdPersonal).HasName("PK__personal__418FB808F7A7578E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__rol__6ABCB5E0CBDFF0BF");
        ...
        {
            entity.HasKey(e => e.IdUbigeo).HasName("PK__ubigeo__F21B090C6F3096C5");
